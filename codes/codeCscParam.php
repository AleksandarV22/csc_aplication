...
if ($_POST['type'] == 'save_csc_param') {
    ...
    if (empty($csc_ra || $csc_cnt1 || $csc_cnt2 || $csc_xnec1 || $csc_xnec2 || $csc_q || $csc_rsba || $csc_rsme || $csc_bame)) {
        $res = [
            'status' => 422,
...
if ($_POST['type'] == 'update_csc_param') {
    ...
    $query = "UPDATE csc_param SET ra_tso='$csc_ra',cnt1_tso='$csc_cnt1',cnt2_tso='$csc_cnt2',xnec1_tso='$csc_xnec1',xnec2_tso='$csc_xnec2',q='$csc_q',rsba='$csc_rsba',rsme='$csc_rsme',bame='$csc_bame' WHERE id='$csc_id'";
